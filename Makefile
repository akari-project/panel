...
.PHONY: ci build build-noui web-build embed gen gen-sqlc gen-clientapi gen-consoleapi check-spec-version check-generated test test-property e2e e2e-portal conformance lint fmt-check vet staticcheck \
