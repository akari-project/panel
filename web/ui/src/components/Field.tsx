  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <textarea
        ...
        aria-describedby={describedBy}
        className={cn(
          'rounded-md border bg-bg px-3 py-2 text-base text-fg placeholder:text-muted',
          error ? 'border-danger' : 'border-border',
          className,
        )}
        {...rest}
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <select
        ...
        aria-invalid={error ? true : undefined}
        aria-describedby={describedBy}
        className={cn('min-h-10 rounded-md border bg-bg px-3 text-base text-fg', error ? 'border-danger' : 'border-border', className)}
        {...rest}
      >
        {children}
      </select>
